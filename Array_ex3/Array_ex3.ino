...
**                               Ex 3                          **                        
**                                                             **          
**  NOM: Albert Puig Viadiu                   DATA: XX/XX/2018 **                                            
****************************************************************/
//********** Includes *************************************************************
//********** Variables ************************************************************
...
void loop()
{
  if (digitalRead(buttonPin) == 0)  // si es compleix la condició fes aixo
  {
     ...
     delay(500);                  // es queden leds 500ms apagats
          ...
          else                    // si no es compleix la condició anterior fes aixo
          {
     digitalWrite(led0, HIGH);    // posar a 5V el pin 5
     digitalWrite(led1, LOW);     // posar a 0V el pin 6
     digitalWrite(led2, HIGH);    // posar a 5V el pin 7
     ...
     delay(500);                  // es queden 500ms encesos els leds 0,2,4 i 6 mentres que els leds 1,3,5 i 7 estan apagats.
     ...
     delay(500);                  // es queden 500ms apagats els leds 0,2,4 i 6 mentres que els leds 1,3,5 i 7 estan encesos
          }
 }
//********** Funcions *************************************************************
