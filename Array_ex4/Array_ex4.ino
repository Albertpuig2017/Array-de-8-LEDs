...
void loop()
{
     ...
     delay(100);                  // es queden 500ms encesos els leds 0,2,4 i 6 mentres que els leds 1,3,5 i 7 estan apagats.
     ...
     delay(100);                  // es queden 500ms apagats els leds 0,2,4 i 6 mentres que els leds 1,3,5 i 7 estan encesos
